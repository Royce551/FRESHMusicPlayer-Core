...
namespace FmpModTrackerBackend
{
    ...
    /// </summary>
    public class MediaPlayerEx : INotifyPropertyChanged, IDisposable
    {
        #region Fields
        ...
        /// </summary>
        public MediaPlayerEx() { _syncContext = SynchronizationContext.Current; }
        ...
        protected virtual int OnLoad(string FileName) => Bass.MusicLoad(FileName, Flags: BassFlags.Prescan);
